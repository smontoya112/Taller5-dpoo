...
public class ProductoAjustado implements Producto
{
    ...
    {
    	int valor = productoBase.getPrecio( );
    	for (Ingrediente ingrediente: agregados) {
    		valor += ingrediente.getCostoAdicional();
    	}
        return valor;
    }
    ...
    public void agregarIngredientes(Ingrediente ing) {
    agregados.add(ing);
    }
    public void eliminarIngredientes(Ingrediente ing) {
        eliminados.add(ing);
        }
}
